 ...
 * From: https://github.com/kpatel122/ESP32-Web-Bluetooth-Terminal
 */
class BluetoothTerminal {
    ...
    send(data) {
        ...
        const chunks = this.constructor._splitByLength(
            data,
    ...
    _requestBluetoothDevice() {
        this._log(
            'Requesting bluetooth device... with service1 ' + this._serviceUuid
        );
        ...
        return (
            navigator.bluetooth
                .requestDevice({
                    filters: [
                        {
                            name: 'Project #51 - Orchestrator',
                        },
                    ],
                    optionalServices: ['6e400001-b5a3-f393-e0a9-e50e24dcca9e', 0xffe0],
                })
